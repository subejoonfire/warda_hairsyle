...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Edit Hairstyle</h1>
            <p class="text-gray-600">Edit hairstyle yang sudah ada</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form action="<?= base_url('admin/hairstyles/edit/' . $hairstyle['id']) ?>" method="POST" id="hairstyleForm">
            <?= csrf_field() ?>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="3" 
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent focus:border-accent"
                                  placeholder="Deskripsi singkat tentang hairstyle ini"><?= old('description', $hairstyle['description']) ?></textarea>
                    ...
                    <div>
                        ...
                        <select id="category_id" name="category_id" 
                            ...
                            <?php foreach ($categories as $category) : ?>
                                <option value="<?= $category['id'] ?>" <?= (old('category_id', $hairstyle['category_id']) == $category['id']) ? 'selected' : '' ?>>
                                    <?= esc($category['name']) ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="url" id="image_url" name="image_url" 
                               value="<?= old('image_url', $hairstyle['image_url']) ?>" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent focus:border-accent"
                    ...
                    <div>
                        ...
                        <input type="number" id="duration_minutes" name="duration_minutes" 
                               value="<?= old('duration_minutes', $hairstyle['duration_minutes'] ?? 60) ?>" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent focus:border-accent"
                    ...
                    <div>
                        ...
                        <select id="difficulty_level" name="difficulty_level" 
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent focus:border-accent">
                            <option value="easy" <?= (old('difficulty_level', $hairstyle['difficulty_level'] ?? 'medium') === 'easy') ? 'selected' : '' ?>>Mudah</option>
                            <option value="medium" <?= (old('difficulty_level', $hairstyle['difficulty_level'] ?? 'medium') === 'medium') ? 'selected' : '' ?>>Sedang</option>
                            <option value="hard" <?= (old('difficulty_level', $hairstyle['difficulty_level'] ?? 'medium') === 'hard') ? 'selected' : '' ?>>Sulit</option>
                        </select>
                    ...
                    <div>
                        ...
                        <input type="number" id="sort_order" name="sort_order" 
                               value="<?= old('sort_order', $hairstyle['sort_order'] ?? 0) ?>" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent focus:border-accent"
                               placeholder="0">
                    ...
                    <div>
                        <label class="flex items-center">
                            <input type="checkbox" id="is_active" name="is_active" 
                                   <?= old('is_active', $hairstyle['is_active']) ? 'checked' : '' ?> 
