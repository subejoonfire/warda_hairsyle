...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit Quick Message</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Form Edit Quick Message</h6>
        </div>
        <div class="card-body">
            <form action="<?= base_url('admin/quick-messages/edit/' . $quick_message['id']) ?>" method="POST">
                <?= csrf_field() ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="keyword" name="keyword" 
                                   value="<?= old('keyword', $quick_message['keyword']) ?>" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="description" name="description" 
                                   value="<?= old('description', $quick_message['description']) ?>">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="response_type" name="response_type" required>
                                ...
                                <option value="static" <?= (old('response_type', $response['response_type'] ?? '') === 'static') ? 'selected' : '' ?>>Static (Teks tetap)</option>
                                <option value="dynamic" <?= (old('response_type', $response['response_type'] ?? '') === 'dynamic') ? 'selected' : '' ?>>Dynamic (Dari database)</option>
                            </select>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" 
                                       <?= old('is_active', $quick_message['is_active']) ? 'checked' : '' ?>>
                ...
                <div class="form-group" id="static_content_group" style="display: none;">
                    ...
                    <textarea class="form-control" id="response_content" name="response_content" rows="10" 
                              placeholder="Masukkan content response..."><?= old('response_content', $response['response_content'] ?? '') ?></textarea>
                    <small class="form-text text-muted">
                ...
                <div class="form-group">
                    <div class="custom-control custom-switch">
                        <input type="checkbox" class="custom-control-input" id="response_active" name="response_active" 
                               <?= old('response_active', $response['is_active']) ? 'checked' : '' ?>>
                        <label class="custom-control-label" for="response_active">Response Aktif</label>
                    </div>
                    <small class="form-text text-muted">Aktifkan/nonaktifkan response untuk quick message ini</small>
                </div>
                <?php endif; ?>

                <div class="form-group">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Update Quick Message
                    </button>
