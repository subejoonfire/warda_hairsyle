    ...
    <div class="bg-white rounded-lg shadow-lg">
        ...
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">Chat dengan Admin</h1>
                    <p class="text-gray-600">Konsultasi atau tanya jawab dengan tim admin kami</p>
                </div>
            ...
            <?php else: ?>
                <?php foreach ($chats as $chat): ?>
                    <div class="flex <?= $chat['sender_type'] === 'customer' ? 'justify-end' : 'justify-start' ?>">
                        <div class="max-w-xs lg:max-w-md px-4 py-2 rounded-lg <?= $chat['sender_type'] === 'customer' ? 'bg-accent text-white' : 'bg-gray-100 text-gray-800' ?>">
                            <div class="text-sm">
            ...
            <form id="chat-form" class="flex space-x-4">
                <div class="flex-1">
                    <textarea id="message-input" 
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-accent focus:border-accent resize-none"
                              rows="2"
                              placeholder="Ketik pesan Anda di sini..."
                              maxlength="500"></textarea>
                </div>
                <button type="submit" 
                        class="bg-accent text-white px-6 py-2 rounded-lg hover:bg-yellow-600 transition duration-300 flex items-center">
